...
public class DCCStatusEntity {
    ...
    public static DCCStatusEntity open() {
        return demoBuilder()
                .results(Arrays.asList(DCCStatusResultEntity.open()))
                .build();
    }
    
    public static DCCStatusEntity failed() {
        return demoBuilder()
                .results(Arrays.asList(DCCStatusResultEntity.failed()))
                .build();
    }
    
    public static DCCStatusEntity passed() {
        return demoBuilder()
                .results(Arrays.asList(DCCStatusResultEntity.passed()))
                .build();
    }
    
    private static DCCStatusEntityBuilder demoBuilder() {
        return DCCStatusEntity.builder()
                .issuer("Demo issuer dgca-booking-demo-backend")
